...
input_dir = "~/tcr-seq/tcr_adaptive"

# Change to path where you wish to store output figures
output_dir = "~/tcr-seq/tcr-seq_out"
...
output_name = "nrg-gy021"

# Path of report (for modifying cohort list) (DEFAULT: NULL)
report_dir = "~/Downloads/tcr-seq/tcr_adaptive/out/ImmuneRepVis/"
